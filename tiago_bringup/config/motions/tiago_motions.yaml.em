...
@[if end_effector in ["schunk-wsg", "robotiq-2f-85", "robotiq-2f-140"]]@
      - positions: [0.25, 0.20, 0.35, @[if end_effector == "robotiq-2f-140"]-0.34@[else]-0.20@[end if], 1.94, -1.57, 1.37, -1.39]
        time_from_start: 0.5
      - positions: [0.18, 0.20, -1.34, @[if end_effector == "robotiq-2f-140"]-0.34@[else]-0.20@[end if], 1.94, -1.57, 1.37, -1.39]
        time_from_start: 4.0
      - positions: [0.15, 0.20, -1.34, @[if end_effector == "robotiq-2f-140"]-0.34@[else]-0.20@[end if], 1.94, -1.57, 1.37, -1.39]
        time_from_start: 7.0
      - positions: [0.15, 0.20, -1.34, @[if end_effector == "robotiq-2f-140"]-0.34@[else]-0.20@[end if], 1.94, -1.57, 1.37, 0.0]
        time_from_start: 9.0
@[else]@
