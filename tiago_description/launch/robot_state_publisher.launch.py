...
class TiagoXacroConfigSubstitution(Substitution):
    ...
    def describe(self) -> Text:
        ...
        return 'Parses tiago hardware launch arguments into xacro arguments potat describe'
...
def generate_launch_description():
    ...
    parameters={'robot_description': Command(
      [
        ...
        ' ',
        PathJoinSubstitution([FindPackageShare('tiago_description'), 'robots', 'tiago.urdf.xacro']),
